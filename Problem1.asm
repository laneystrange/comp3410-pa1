...
prompt:	.asciiz	  "How many numbers would you like to print? (less than 9)\n"
...
print:	add  $t0, $zero, $a0  # starting address of array of data to be printed
	      ...
	      la $a0, prompt	#Prints the prompt for the user to enter a number
	      li $v0, 4
	      syscall 
	      
	      li $v0, 5
	      syscall
	      bge $v0, $s5, out		#If the number is greater than or equal to 9, it only prints the first 9 numbers
