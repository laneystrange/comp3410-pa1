...
fibs:	.word   0 : 9         # Array variable named "fibs" of 9 word-length elements (4 bytes each)
size:	.word  9              # Single integer variable named "size" that indicates the length of the array
input: .asciiz "\ Size of the array\n"
